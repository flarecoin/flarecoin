...
static const int64 MAX_MONEY = 1051200000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 960 / 250; // 960 blocks found a day. Priority cutoff is 1 SMC day / 250 bytes.
    }
