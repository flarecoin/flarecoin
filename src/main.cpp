...
uint256 hashGenesisBlock("0xca758c723cd312e9c6d59928ebb9f89dae481cc1bfaf4edab905fdb6d38e7ff4");
...
const string strMessageMagic = "FlareCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1401600); //Half block reward after half of blocks discovered in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2.5 * 24 * 60 * 60; // FlareCoin: 2.5 days
static const int64 nTargetSpacing = 90; // FlareCoin: 1.5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal flarecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FlareCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcb36bf044afb80a07db13ae0180c858e35be23e6cf0ae89f41818c5ecfa3635f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Terrorist bombing in Russia before 2014 Olympics.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388433745; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 736048;

        if (fTestNet)
        {
            block.nTime    = 1388426571;
            block.nNonce   = 1575545;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf9921ac54c26dad5dcca9d8208be2c4191bd5814b87df12adf89daa8b777ac0d"));
